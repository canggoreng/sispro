								...
								<table class="table table-striped table-dark mb-0">
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-bold-500">
												<select id="select_dokter" class="choices form-select" name="nm_dokter" required>
										...
										<tr>
											<td class="text-bold-500"><center><strong></strong></center></td>
											<td class="text-bold-500"><center><strong></strong></center></td>
											<td class="text-bold-500"><strong></strong></td>
											<td class="text-bold-500"><center><strong>:</strong></center></td>
											@if($data->nm_dokter2 == null)
											<td class="text-bold-500">
										...
										<tr>
											...
											<td class="text-bold-500"><strong></strong></td>
											<td class="text-bold-500"><center><strong>:</strong></center></td>
											@if($data->nm_dokter3 == null)
											<td class="text-bold-500">
												<select id="select_dokter" class="choices form-select" name="nm_dokter3" required>
													<option>| Pilih Nama Dokter DPJP |</option>
													@foreach($master_dokter as $data2)
													<option value="{{$data2->nm_dokter}}">{{$data2->nm_dokter}}</option>
													@endforeach
											...
											<td class="text-bold-500">
												<select id="select_dokter" class="choices form-select" name="nm_dokter3" required>
													<option value="{{$data->nm_dokter3}}">{{$data->nm_dokter3}}</option>
													@foreach($master_dokter as $data2)
													<option value="{{$data2->nm_dokter}}">{{$data2->nm_dokter}}</option>
													@endforeach
												</select>
