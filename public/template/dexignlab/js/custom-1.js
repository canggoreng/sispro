...
var MyIntro = (function () {
    ...
    var handleSupport = function () {
        var support = jQuery("body").append(support);
    };
    ...
    WebsiteLaunchDate =
        WebsiteCurrentDate.getDate() +
        " " +
        monthNames[WebsiteCurrentDate.getMonth()] +
        " " +
        WebsiteCurrentDate.getFullYear();
